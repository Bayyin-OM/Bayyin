...
const SIM_META = {
  ...
  g7states2:    { title: '٢ · نظرية الجزيئات', badge: '🧊 7', tabs: ['كيف تتحرّك الجزيئات؟ 🔬', 'طابق الملاحظات 🔗'] },
  g7states3:    { title: '٣ · تغيّر الحالة', badge: '🔥 7', tabs: ['استقصاء: غلي الماء 🔥'] },
  g7states5:    { title: '٥ · الانتشار', badge: '🔬 7', tabs: ['استقصاء: شاهد الانتشار 🔬'] },
