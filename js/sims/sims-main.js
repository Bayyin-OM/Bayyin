...
const SIM_META = {
  ...
  g8bio1n3:     { title: 'نشاط 1-3 · التمثيل الضوئي', badge: '🔬 8', tabs: ['معادلة التمثيل الضوئي ☀️', 'استقصاء: الكشف عن النشاء 🔬'] },
...
function openSim(type) {
  ...
  var simGreets = {
    ...
    g8bio1n3:'هل تحتوي الورقة على نشاء؟ 🔬 اكتشف بنفسك في المختبر الافتراضي!',
...
function startSim(type, tab) {
  ...
  const fns = {
    ...
    g8bio1n3: [simG8Bio1N3a, simG8Bio1N3b],
    // ── الصف 8 — الجهاز الدوري وتبادل الغازات ──
