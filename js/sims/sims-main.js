...
const SIM_META = {
  ...
  g6body2:      { title: '١-٢ · القلب', badge: '❤️ 6', tabs: ['استقصاء: نبضات القلب ❤️', 'اكتشف حقائق عن الدم 🩸'] },
...
function openSim(type) {
  ...
  var simGreets = {
    ...
    g6body2:     'اضغط ابدأ وشاهد قلبك ينبض! ❤️ جرّب تغيير السرعة ثم اكتشف حقائق عن الدم',
