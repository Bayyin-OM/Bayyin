...
var _semesterConfig = {
  1: {
    ...
    accentColor: '#D4901A',
    grades: [
      { g:5, icon:'🔭', label:'الصف الخامس',  count:'٥ استقصاءات',  available: true },
      { g:6, icon:'📗', label:'الصف السادس',  count:'٧ استقصاءات',  available: true },
...
function openUnit(id, el) {
  ...
  var hints = {
    ...
    u6body:'وحدة جسم الإنسان 🫀 — اكتشف أعضاءك ووظيفة كل عضو!',
    u6eco:'وحدة الكائنات الحية في البيئة 🌱 — سلاسل غذائية، مواطن طبيعية، والاعتناء بالبيئة!',
    u6changes:'وحدة تغيّرات المادة 🔁 — بعض التغيّرات يمكن الرجوع عنها، وبعضها لا! اكتشف الفرق بنفسك.',
    u6f:'وحدة القوى 🏋️ — الدفع والسحب والاحتكاك في كل مكان!',
    u6e:'وحدة الكهرباء ⚡ — المعادن توصّل والبلاستيك يعزل. ابنِ دائرتك!',
    u7energy:'وحدة الطاقة ⚡ — كل حركة وكل تغيير يحتاج إلى طاقة! اكتشف من أين تأتي.',
    u7cells:'وحدة الخلايا والكائنات الحية 🔬 — هل هو حيّ أم غير حيّ أم ميت؟ وماذا يوجد داخل الخلية؟ اكتشف بنفسك!',
    u7earth:'وحدة الأرض 🌍 — من مكوّنات التربة إلى مسامية الصخور وتحوّلها. اكتشف أسرار الأرض من تحت أقدامك!',
    u7states:'وحدة حالات المادّة 🧊 — جزيئات المادّة الصلبة تهتزّ في مكانها، وجزيئات الغاز تتحرّك بحرّية! اكتشف الفرق.',
    u5water:'وحدة حالات المادّة 💧 — التبخّر والغليان والانصهار، اكتشف كيف تتغيّر المادّة!',
    ...
    u8plants:'وحدة النباتات 🌱 — النبات مصنع غذاء يعمل بالطاقة الشمسية! اكتشف كيف يحدث التمثيل الضوئي.',
...
const SIM_META = {
  ...
  // Unit 9
  // الصف السادس
  // ── الصف 6 — جسم الإنسان (الفصل الدراسي الأول) ──
  g6body1:      { title: '١-١ · أعضاء الجسم', badge: '🫀 6', tabs: ['استقصاء: أعضاء الجسم 🫀', 'من المسؤول؟ 🎯'] },
  g6body2:      { title: '١-٢ · القلب', badge: '❤️ 6', tabs: ['استقصاء: نبضات القلب ❤️', 'لنتعرّف على الدم 🩸'] },
  g6body3:      { title: '١-٣ · القلب والنبض', badge: '📈 6', tabs: ['استقصاء: القلب والنبض ❤️', 'طابق النشاط بالنبض 🎯'] },
  g6body4:      { title: '١-٤ · الرئتان والتنفس', badge: '🫁 6', tabs: ['استقصاء: الرئتان والتنفس 🫁', 'وصّل ونظّف الدم 🔄'] },
  g6body5:      { title: '١-٥ · الجهاز الهضمي', badge: '🍽️ 6', tabs: ['استقصاء: رحلة الطعام 🍽️', 'رتّب أعضاء الجهاز الهضمي 🔀'] },
  g6body6:      { title: '١-٦ · ما وظيفة الكُليتين؟', badge: '🫘 6', tabs: ['استقصاء: كيف تعمل الكليتان؟ 🫘', 'فرز المواد 🧪'] },
  g6body7:      { title: '١-٧ · ما وظيفة الدماغ؟', badge: '🧠 6', tabs: ['استقصاء: كيف يعمل الدماغ؟ 🧠', 'من المسؤول؟ 🎯'] },
  // ── الصف السادس — الوحدة ٢: الكائنات الحية في البيئة ──
  g6eco1: { title: '١-٢ · السلاسل الغذائية في الموطن الطبيعي المحلي', badge: '🌱 6', tabs: ['استكشف الموطن الطبيعي 🔎', 'منتج أم مستهلك؟ 🎯', 'ابنِ سلسلة غذائية 🔗'] },
  g6eco2: { title: '٢-٢ · السلاسل الغذائية تبدأ بالنباتات', badge: '☀️ 6', tabs: ['ابدأ السلسلة من الشمس ☀️', 'ماذا لو لم ينمُ النبات؟ 🤔'] },
  g6eco3: { title: '٣-٢ · الكائنات الحية المستهلِكة', badge: '🦅 6', tabs: ['من يأكل من؟ 🔗'] },
  g6eco4: { title: '٤-٢ · السلاسل الغذائية في المواطن المختلفة', badge: '🌊 6', tabs: ['صنّف الكائنات 🌳🌊', 'سلسلتان غذائيتان 🔗'] },
  g6eco5: { title: '٥-٢ · إزالة الغابات', badge: '🌳 6', tabs: ['ماذا سيحدث للغابة؟ 🪓'] },
  g6eco6: { title: '٦-٢ · تلوث الهواء', badge: '💨 6', tabs: ['محطة مراقبة الهواء 🔬', 'الجدول والرسم البياني 📊'] },
  g6eco7: { title: '٧-٢ · الأمطار الحمَضية', badge: '🌧️ 6', tabs: ['تأثير الأمطار الحمضية في النباتات 🌱'] },
  g6eco8: { title: '٨-٢ · إعادة التدوير', badge: '♻️ 6', tabs: ['إلى أين تذهب هذه النفايات؟ 🗑️'] },
  g6eco9: { title: '٩-٢ · الاعتناء بالبيئة', badge: '🏡 6', tabs: ['اجعل منزلك أكثر حفاظاً على البيئة 🌍'] },
  // ── الصف السادس — الوحدة ٣: تغيّرات المادة ──
  g6changes1: { title: '١-٣ · التغيّرات القابلة للعكس وغير القابلة للعكس', badge: '🔁 6', tabs: ['ذوبان الثلج وتجمّده ❄️', 'إشعال عود الثقاب 🔥', 'صنّف التغيّرات 🧩'] },
  g6changes2: { title: '٢-٣ و ٤-٣ · اختر طريقة الفصل الصحيحة', badge: '🧻 6', tabs: ['غربال أم فرز باليد؟ 🔲', 'الترشيح 🧻', 'التحدي الأخير 🏆'] },
  g6changes3: { title: '٣-٣ و ٥-٣ · يذوب أم لا يذوب؟', badge: '💧 6', tabs: ['توقّع ثم اختبر 🧪', 'محلول أم مخلوط؟ 💧'] },
  g6changes4: { title: '٦-٣ و ٧-٣ · سباق الذوبان', badge: '⏱️ 6', tabs: ['الحرارة والتحريك 🌡️', 'حجم الحبيبات 🔎', 'التحدي الأخير 🏆'] },
  ...
  // ── الصف 8 — النباتات (الفصل الدراسي الأول) ──
  g8bio1n1:     { title: 'نشاط 1-1 · التمثيل الضوئي', badge: '🌱 8', tabs: ['كيف يحدث التمثيل الضوئي؟ ☀️', 'تأثير الضوء على النمو 🌱'] },
  g8bio1n2:     { title: 'نشاط 1-2 · أجزاء النبات', badge: '🍃 8', tabs: ['استقصاء الورقة 🍃', 'أجزاء النبات 🌱', 'مختبر الثغور 🔬'] },
  g8bio1n3:     { title: 'نشاط 1-3 · التمثيل الضوئي', badge: '☀️ 8', tabs: ['معادلة التمثيل الضوئي ☀️'] },
  g8bio1n4:     { title: 'نشاط 1-4 · الكشف عن النشاء', badge: '🔬 8', tabs: ['استقصاء: الكشف عن النشاء 🔬'] },
  g8bio1n5:     { title: 'نشاط 1-5 · الجذور', badge: '🌱 8', tabs: ['إلى أيّ اتجاه تنمو الجذور؟ 🌱'] },
  g8bio1n6:     { title: 'نشاط 1-6 · نقل الماء والأملاح المعدنية', badge: '🥬 8', tabs: ['النقل في ساق الكرفس 🥬'] },
  g8chem2n9:    { title: 'نشاط 9-2 · المركّبات والمخاليط', badge: '⚗️ 8', tabs: ['الحديد والكبريت 🧲', 'الهواء — مخلوط من الغازات 💨'] },
  g8bio3n1:     { title: 'نشاط 1-3 · كيف ينتقل الضوء؟', badge: '💡 3', tabs: ['هل يسير في خط مستقيم؟ 🕯️', 'كيف نرى الأجسام؟ 👁️'] },
  g8bio3n2:     { title: 'نشاط 2-3 · كيف تتكوّن الظلال؟', badge: '🌳 3', tabs: ['مواد شفّافة ومعتمة وعاكسة 🚗', 'كيف يتكوّن الظلّ؟ 🌑'] },
  g8bio3n3:     { title: 'نشاط 3-3 · كيف تتكوّن الانعكاسات؟', badge: '🪞 3', tabs: ['المرآة أم الورقة؟ 🪞', 'زاوية السقوط والانعكاس 📐'] },
  g8bio3n4:     { title: 'نشاط 4-3 · كيف ينكسر الضوء؟', badge: '🖊️ 3', tabs: ['هل يبدو القلم مكسوراً؟ 🖊️', 'مسار الشعاع في الزجاج 📐'] },
  g8bio3n5:     { title: 'نشاط 5-3 · طيف الضوء الأبيض', badge: '🌈 3', tabs: ['المنشور الزجاجي 🔺', 'أيّ لون ينكسر أكثر؟ 🔴🟣'] },
  g8bio3n6:     { title: 'نشاط 6-3 · الضوء الملوّن', badge: '🎨 3', tabs: ['كيف تعمل المرشّحات؟ 🔍', 'لماذا نرى السيارة حمراء؟ 🚗🌿'] },
  g8mot6n1:     { title: 'نشاط 1-6 · السرعة', badge: '🏁 6', tabs: ['من الأسرع؟ 🏁', 'جرّبي بنفسك 🎚️'] },
  g8mot6n2:     { title: 'نشاط 2-6 · التحقّق من السرعة', badge: '📡 6', tabs: ['البوابتان الضوئيتان 📡', 'قارني السرعات 🐢🏎️'] },
  g8mot6n3:     { title: 'نشاط 3-6 · حساب السرعة', badge: '🔺 6', tabs: ['مثلّث السرعة 🔺', 'مسائل تطبيقية 📝'] },
  g8mot6n4:     { title: 'نشاط 4-6 · أنماط الحركة', badge: '📈 6', tabs: ['السيارة والرسم البياني 🚗📈', 'سرعة ثابتة أم متزايدة؟ 📸'] },
  g8mot6n5:     { title: 'نشاط 5-6 · تطبيقات على الرسوم البيانية', badge: '🚵 6', tabs: ['سيارتان بسرعتين مختلفتين 🔴🔵', 'رحلة الدرّاجة الهوائية 🚵'] },
  g8mot6n6:     { title: 'نشاط 6-6 · عزم دوران القوة', badge: '🔧 6', tabs: ['مفتاح البراغي 🔧', 'فتح الباب 🚪'] },
  g8mot6n7:     { title: 'نشاط 7-6 · مبدأ عزم القوة', badge: '⚖️ 6', tabs: ['ميزان التفاح ⚖️', 'مبدأ العزم على الأرجوحة 🎢'] },
  g8mot6n8:     { title: 'نشاط 8-6 · حساب عزم القوة', badge: '🧮 6', tabs: ['احسبي عزم القوة 🧮', 'تحدّي العزم 📝'] },
  g8chem2n2:    { title: 'نشاط 2-2 · الذرّات والعناصر', badge: '⚛️ 8', tabs: ['مكوّنات الذرّة ⚛️'] },
  // ── الصف السابع — الوحدة الثانية: حالات المادّة ──
  // ── الصف الخامس — الوحدة الثالثة: التبخر ──
  g5water1:     { title: '٣ · استقصاء التبخر', badge: '💧 5', tabs: ['أين يتبخّر الماء أسرع؟ 🔬'] },
  g5water2:     { title: '٤(ب) · استعادة الملح', badge: '🧂 5', tabs: ['هل يمكنك استعادة الملح؟ 🧪'] },
  g5water3:     { title: '٧(ب) · استقصاء الغليان', badge: '🔥 5', tabs: ['استقصاء درجة غليان الماء 🌡️'] },
  g5water4:     { title: '٨ · استقصاء الانصهار', badge: '🧊 5', tabs: ['استقصاء درجة انصهار الثلج ❄️'] },
  g7states2:    { title: '٢-٢ · نظرية الجزيئات', badge: '🧊 7', tabs: ['كيف تتحرّك الجزيئات؟ 🔬', 'طابق الملاحظات 🔗'] },
  g7states3:    { title: '٣-٢ · تغيّر الحالة', badge: '🔥 7', tabs: ['استقصاء: غلي الماء 🔥'] },
  g7states5:    { title: '٥-٢ · الانتشار', badge: '🔬 7', tabs: ['استقصاء: شاهد الانتشار 🔬'] },
  // ── الصف السابع — الوحدة الثالثة: الطاقة ──
  g7energy1:    { title: '٣-١ · استخدام الطاقة', badge: '⚡ 7', tabs: ['هل تستطيع تشغيلها؟ 🎈', 'اكتشف مصدر الطاقة 🏙️'] },
  g7energy2:    { title: '٣-٢ · المخازن الكيميائية للطاقة', badge: '🕯️ 7', tabs: ['الطاقة من الوقود 🧪'] },
  g7energy3:    { title: '٣-٣ · مخازن أخرى للطاقة', badge: '🔋 7', tabs: ['اكتشف مخزن الطاقة 🎮'] },
  g7energy4:    { title: '٣-٤ · طاقة الحركة', badge: '🚗 7', tabs: ['مختبر الطاقة الحركية 🧪', 'أين ذهبت الطاقة؟ 🔥'] },
  g7energy5:    { title: '٣-٥ · الطاقة الحرارية', badge: '🌡️ 7', tabs: ['اخلط الماء واكتشف الطاقة الحرارية 🌡️', 'أين تذهب الطاقة الحرارية؟ ❄️'] },
  g7energy6:    { title: '٣-٦ · نقل الطاقة', badge: '🔌 7', tabs: ['كيف وصلت الطاقة؟ ⚡'] },
  g7energy7:    { title: '٣-٧ · توصيل الحرارة', badge: '🧲 7', tabs: ['أي فلز يوصل الحرارة أسرع؟ 🔥', 'سباق ذوبان الثلج 🧊'] },
  g7energy8:    { title: '٣-٨ · الحمل الحراري', badge: '🌀 7', tabs: ['ملاحظة تيار الحمل الحراري 🌀'] },
  g7energy9:    { title: '٣-٩ · الإشعاع', badge: '🔴 7', tabs: ['كيف تفقد الأجسام حرارتها؟ 🔴'] },
  // ── الصف السابع — الوحدة الرابعة: الخلايا والكائنات الحية ──
  g7cell1: { title: '٤-١ · خصائص الكائنات الحية', badge: '🔍 7', tabs: ['هل هو حي أم غير حي أم ميت؟ 🔍'] },
  g7cell2: { title: '٤-٢ · الكائنات الدقيقة', badge: '🦠 7', tabs: ['استزراع الكائنات الدقيقة من الهواء 🦠'] },
  g7cell3: { title: '٤-٣ · الكائنات الدقيقة والتحلّل', badge: '🍞 7', tabs: ['تأثير درجة الحرارة على التحلّل 🍞'] },
  g7cell4: { title: '٤-٤ · الكائنات الدقيقة والغذاء', badge: '🥛 7', tabs: ['صنع الزبادي 🥛', 'الخميرة وعجينة الخبز 🍞'] },
  g7cell6: { title: '٤-٦ · الخلايا النباتية', badge: '🧅 7', tabs: ['فحص الخلايا النباتية 🧅'] },
  g7cell7: { title: '٤-٧ · الخلايا الحيوانية', badge: '👄 7', tabs: ['فحص الخلايا الحيوانية 👄'] },
  // ── الصف السابع — الوحدة الخامسة: الأرض ──
  g7earth2b: { title: '٥-٢ (ب) · فحص مكوّنات التربة', badge: '🫙 7', tabs: ['مختبر تحليل التربة 🫙'] },
  g7earth2c: { title: '٥-٢ (ج) · تصريف التربة للماء', badge: '💧 7', tabs: ['سباق تصريف الماء 💧'] },
  g7earth4:  { title: '٥-٤ · مسامية الصخور الرسوبية', badge: '🪨 7', tabs: ['مختبر مسامية الصخور 🪨'] },
  g7earth5:  { title: '٥-٥ · خصائص الصخور', badge: '🔥 7', tabs: ['مختبر فحص الصخور 🔥'] },
  g7bio1n1:     { title: 'نشاط 1-1 · أعضاء النبات', badge: '🌱 7', tabs: ['ابنِ النبات 🌱', 'صِل العضو بوظيفته 🔗'] },
  g7bio1n2:     { title: 'نشاط 2-1 · الأزهار', badge: '🌸 7', tabs: ['ركّبي أجزاء الزهرة 🌸', 'استكشفي الزهرة 🔍'] },
  g7bio1n3:     { title: 'نشاط 3-1 · التلقيح', badge: '🐝 7', tabs: ['رحلة النحلة 🐝', 'استكشفي حبوب اللقاح 🔍', 'من الناقل؟ 🌬️'] },
  g7bio1n4:     { title: 'نشاط 4-1 · الإخصاب', badge: '🌼 7', tabs: ['رحلة حبّة اللقاح 🌼', 'من بويضة إلى بذرة 🌰'] },
  g7bio1n5:     { title: 'نشاط 5-1 · الثمار', badge: '🍎 7', tabs: ['إلى أين ستذهب البذرة؟ 🍇', 'مصنع الثمار 🍎'] },
  g7bio1n6:     { title: 'نشاط 6-1 · أجهزة جسم الإنسان', badge: '❤️ 7', tabs: ['من الجهاز المسؤول؟ 🧍', 'رحلة الأكسجين 🌬️'] },
  g7bio1n7:     { title: 'نشاط 7-1 · الهيكل العظمي للإنسان', badge: '🦴 7', tabs: ['حارس الأعضاء 🛡️', 'أيّ ماصّة تحتاج قوّة أكبر؟ 🔬'] },
  g7bio1n8:     { title: 'نشاط 8-1 · المفاصل', badge: '🦴 8', tabs: ['جرّب الحركة واكتشف المفصل 🖐'] },
  g7bio1n9:     { title: 'نشاط 9-1 · العضلات', badge: '💪 9', tabs: ['من الذي تحرّك؟ 💪', 'شدّ الحبل 🪢'] },
  g7bio1n10:    { title: 'نشاط 10-1 · دراسة جسم الإنسان', badge: '🔬 10', tabs: ['من أنا؟ 🔎'] },
  g5bio1n1:     { title: 'نشاط 1-1 · البذور', badge: '🌰 5', tabs: ['استكشفي البذرة 🌰'] },
  g5bio1n2:     { title: 'نشاط 2-1 · كيف تنمو البذور؟', badge: '🌱 5', tabs: ['مراحل الإنبات 🌱'] },
  g5bio1n3:     { title: 'نشاط 3-1 · استقصاء عملية الإنبات', badge: '🌬️ 5', tabs: ['هل تحتاج البذور إلى الهواء؟ 🌬️', 'هل تحتاج البذور إلى الدفء؟ 🌡️'] },
  g5bio1n4:     { title: 'نشاط 4-1 · ماذا يحتاج النبات كي ينمو؟', badge: '🌿 5', tabs: ['قارني النباتات الأربعة 🌿'] },
  g5bio1n5:     { title: 'نشاط 5-1 · النبات والضوء', badge: '☀️ 5', tabs: ['نبات الشمس والظلام ☀️'] },
  ...
  // ── الصف العاشر — كيمياء: الوحدة ١ (الفلزات وخصائصها) ──
...
const SIM_QUESTIONS = {
  g10chem1n1: {
    q: 'لماذا تستطيع الفلزات نقل الشحنات الكهربائية؟',
    opts: [
      'لأن الإلكترونات الحرة غير المتمركزة تتحرك بحرية وتنقل الشحنة عبر الفلز',
      'لأن الأيونات الموجبة نفسها تتحرك بسرعة كبيرة',
      'لأن الفلزات تحتوي على الماء داخل تركيبها',
      'لأن الرابطة الفلزية ضعيفة جداً وتنكسر بسهولة'
    ],
    ans: 0,
    fb: '✅ الإلكترونات غير المتمركزة قادرة على التحرك بحرية عبر التركيب البنائي للفلز، ناقلةً معها التيار الكهربائي.'
  },
  g10chem1n2: {
    q: 'إلى أي مجموعة ينتمي عنصر الصوديوم (Na)؟',
    opts: ['المجموعة الأولى (الفلزات القلوية)', 'العناصر الانتقالية', 'المجموعة السابعة', 'المجموعة صفر'],
    ans: 0,
    fb: '✅ الصوديوم (Na) من عناصر المجموعة الأولى، وتُسمّى فلزّات هذه المجموعة بالفلزات القلوية.'
  },
  g10chem1n4: {
    q: 'أيّ عنصر هو الأكثر نشاطاً في تفاعل الخارصين مع محلول كبريتات النحاس (II)؟',
  ...
  g10chem2n3: {
    q: 'لماذا يُضخّ الأكسجين داخل الفرن المحوّل أثناء صناعة الفولاذ؟',
    opts: [
      'لتبريد الحديد المنصهر بسرعة',
      'لأكسدة (حرق) الكربون الزائد والشوائب مثل الكبريت والفوسفور',
      'لإذابة خردة الفولاذ فقط',
      'لزيادة نسبة الكربون في الفولاذ'
    ],
    ans: 1,
    fb: '✅ يُضخّ الأكسجين عالي السرعة لأكسدة الكربون الزائد والشوائب (الكبريت، الفوسفور، السيليكون)، فتخرج كغازات أو تتحد مع الجير مكوّنةً الخبث.'
  },
  g10chem2n4: {
    q: 'ما الشرطان الضروريان معاً لحدوث صدأ الحديد؟',
    opts: ['الماء وحده', 'الأكسجين وحده', 'الماء والأكسجين معاً', 'الحرارة العالية فقط'],
    ans: 2,
  ...
  g10chem2n4_1: {
    ...
    opts: [
      ...
      'لأن النحاس أقل نشاطاً كيميائياً من الحديد، فلا يتأكسد هو بدلاً منه',
      'لأن النحاس موصل جيد للحرارة',
      'لأن النحاس يذوب في الماء'
    ],
    ans: 1,
    fb: '✅ النحاس أقل نشاطاً من الحديد، فعكس الجلفنة (حيث الخارصين أنشط ويحمي الحديد)، هنا الحديد نفسه هو الأكثر نشاطاً فيفقد إلكتروناته ويصدأ بسرعة أكبر.'
  },
  g5bio1n5: {
    q: 'ماذا تحتاج النباتات لكي تصنع غذاءها وتنمو جيّداً؟',
    opts: ['الطاقة الضوئية', 'الظلام', 'الملح', 'الرمل'],
    ans: 0,
    fb: '✅ تحتاج النباتات إلى الطاقة الضوئية لتنمو جيّداً ولصنع الغذاء داخل أوراقها.'
  },
  g5bio1n4: {
    q: 'ما العوامل التي تحتاجها النباتات كي تنمو؟',
    opts: ['الماء، والدفء، والضوء، والهواء', 'الرمل فقط', 'الظلام فقط', 'الملح فقط'],
    ans: 0,
    fb: '✅ تحتاج النباتات إلى أشياء محدَّدة من البيئة لكي تنمو، مثل الماء والدفء والضوء والهواء.'
  },
  g5bio1n3: {
    q: 'هل تحتاج البذور إلى الهواء لكي تنبت؟',
    opts: ['نعم', 'لا', 'فقط في الليل', 'فقط في الشتاء'],
    ans: 0,
    fb: '✅ تحتاج البذور إلى الهواء، بالإضافة إلى الماء والدفء، لكي تنبت.'
  },
  g5bio1n2: {
    q: 'أيّ جزء ينمو أولاً عندما تبدأ البذرة بالإنبات؟',
    opts: ['الجذر الأول', 'الساق الأول', 'الأوراق', 'الزهرة'],
    ans: 0,
    fb: '✅ في البداية ينمو الجذر الأول متجهاً إلى الأسفل، ثمّ يتبعه الساق الأول الذي ينمو متجهاً إلى الأعلى.'
  },
  g5bio1n1: {
    q: 'ما اسم النبات الصغير جداً الموجود داخل البذرة؟',
    opts: ['الجنين', 'الندبة', 'غلاف البذرة', 'مخزون الغذاء'],
    ans: 0,
    fb: '✅ يوجد نباتٌ صغيرٌ جداً داخل البذرة يُسمّى الجنين، ويبدأ بالنمو عندما تتوافر له الظروف المناسبة.'
  },
  g7bio1n10: {
    q: 'أراد طبيب معرفة كيف يرسل الدماغ الإشارات العصبيّة إلى اليد، فمن التخصّص الأنسب لمساعدته؟',
    opts: ['عالِم الأعصاب', 'عالِم فسيولوجيا الرياضة', 'عالِم النبات', 'عالِم الفلك'],
    ans: 0,
    fb: '✅ عالِم الأعصاب هو عالِم فسيولوجيا متخصّص يدرس الدماغ والجهاز العصبيّ وكيفيّة إرسال الإشارات العصبيّة.'
  },
  g7bio1n9: {
    q: 'أيّ العضلتين تنقبض عند ثني المرفق لرفع أحد الأشياء؟',
    opts: ['العضلة ذات الرأسين', 'العضلة ثلاثية الرؤوس', 'كلتاهما بالدرجة نفسها', 'لا تعمل أيّ عضلة'],
    ans: 0,
    fb: '✅ عند ثني المرفق تنقبض العضلة ذات الرأسين فتقصر وتشدّ عظام الساعد نحو الأعلى، بينما تنبسط العضلة ثلاثية الرؤوس.'
  },
  g7bio1n8: {
    q: 'أيّ نوع من المفاصل يسمح بالحركة في اتّجاهات متعدّدة تقريباً، مثل مفصل الكتف؟',
    opts: ['مفصل كرويّ', 'مفصل ثابت', 'مفصل رَزّي', 'لا يوجد مفصل يسمح بذلك'],
    ans: 0,
    fb: '✅ المفصل الكرويّ (Ball-and-socket Joint) مثل الكتف والفخذ يسمح بالحركة في جميع الاتّجاهات تقريباً.'
  },
  g7bio1n7: {
    q: 'إذا اختفت عظام القفص الصدري من جسم الإنسان، فما العضوان اللذان سيصبحان أقل حماية؟',
    opts: ['القلب والرئتان', 'الدماغ والعينان', 'المعدة والكبد', 'اليدان والقدمان'],
    ans: 0,
    fb: '✅ تساعد الأضلاع وعظم القصّ على تكوين القفص الصدري الذي يحمي القلب والرئتين.'
  },
  g7bio1n6: {
    q: 'أيّ الأجهزة يساعد على نقل الأكسجين إلى جميع خلايا الجسم؟',
    opts: ['الجهاز الدوري', 'الجهاز الهضمي', 'الجهاز العصبي', 'الجهاز العضلي'],
    ans: 0,
    fb: '✅ الجهاز التنفسي يُدخل الأكسجين إلى الجسم، ثمّ يساعد الجهاز الدوري على نقله إلى جميع أجزاء الجسم.'
  },
  g7bio1n5: {
    q: 'لماذا من الأفضل أن تنتشر البذور بعيداً عن النبات الأمّ؟',
    opts: ['لكي تحصل النباتات الجديدة على مساحة وضوء وماء كافٍ للنمو', 'لكي تصبح الثمار أكبر حجماً', 'لكي تتغيّر ألوان الأزهار', 'لكي تنتج حبوب لقاح أكثر'],
    ans: 0,
    fb: '✅ يساعد انتشار البذور بعيداً عن النبات الأمّ على تقليل التنافس والحصول على الموارد اللازمة للنمو.'
  },
  g7bio1n4: {
    q: 'ماذا يحدث بعد أن يصل أنبوب اللقاح إلى البويضة؟',
    opts: ['تبدأ بذرة جديدة بالتكوّن داخل الزهرة', 'تسقط الزهرة مباشرة', 'تتكوّن أوراق جديدة', 'تنتج الزهرة جذوراً جديدة'],
    ans: 0,
    fb: '✅ بعد الإخصاب تبدأ البويضة بالنمو لتكوّن بذرة تحتوي على جنين نبات جديد.'
  },
  g7bio1n3: {
    q: 'ما اسم انتقال حبوب اللقاح من المتك إلى الميسم؟',
    opts: ['التلقيح', 'الإخصاب', 'الإنبات', 'النتح'],
    ans: 0,
    fb: '✅ تُسمّى عملية انتقال حبوب اللقاح من المتك إلى الميسم بالتلقيح (Pollination).'
  },
  g7bio1n2: {
    q: 'أين توجد الأمشاج الذكرية في الزهرة؟',
    opts: ['داخل حبوب اللقاح في المتك', 'داخل البويضات في المبيض', 'في البتلات', 'في الميسم'],
    ans: 0,
    fb: '✅ تحتوي حبوب اللقاح الموجودة في المتك (جزء من الأسدية) على الأمشاج الذكرية.'
  },
  g7bio1n1: {
    q: 'ما وظيفة الجذور في النبات؟',
    opts: ['تثبيت النبات في التربة وامتصاص الماء والأملاح المعدنية', 'صنع الغذاء بامتصاص ضوء الشمس', 'إنتاج البذور', 'حمل الأوراق والأزهار فوق التربة'],
    ans: 0,
    fb: '✅ تثبّت الجذور النبات في التربة وتمتصّ منها الماء والأملاح المعدنية.'
  },
  g8chem2n2: {
    q: 'من ماذا تتكوّن نواة الذرّة؟',
    opts: ['من البروتونات والنيوترونات', 'من الإلكترونات فقط', 'من البروتونات فقط', 'من مساحة فارغة تماماً'],
    ans: 0,
    fb: '✅ تتكوّن نواة الذرّة من البروتونات والنيوترونات، بينما تتحرّك الإلكترونات حولها.'
  },
  g8bio3n1: {
    q: 'كيف نستطيع رؤية جسم غير مضيء مثل الكتاب؟',
    opts: ['عندما يصل الضوء المنعكس عنه إلى أعيننا', 'لأنّ الكتاب يصدر ضوءاً خاصاً به', 'لا يمكن رؤيته أبداً', 'بسبب حرارة الجسم فقط'],
    ans: 0,
    fb: '✅ الجسم غير المضيء (Non-Luminous) لا يصدر ضوءاً بنفسه، لكنّنا نراه عندما يصل الضوء المنعكس عنه إلى أعيننا.'
  },
  g8bio3n2: {
    q: 'لماذا يُعتبر الزجاج الأمامي للسيارة مادة شفّافة؟',
    opts: ['لأنّه ينفذ الضوء ويسمح له بالمرور عبره', 'لأنّه يمتصّ كلّ الضوء الساقط عليه', 'لأنّه يعكس كلّ الضوء الساقط عليه', 'لأنّه لا يتفاعل مع الضوء إطلاقاً'],
    ans: 0,
    fb: '✅ المادة الشفّافة (Transparent) تنفذ الضوء (Transmitted) ويمرّ مباشرةً عبرها، كما هو حال الزجاج.'
  },
  g8bio3n3: {
    q: 'وفقاً لقانون الانعكاس، ما العلاقة بين زاوية السقوط وزاوية الانعكاس؟',
    opts: ['زاوية السقوط تساوي زاوية الانعكاس', 'زاوية السقوط أكبر دائماً من زاوية الانعكاس', 'لا توجد علاقة بينهما', 'يعتمد ذلك على لون الضوء فقط'],
    ans: 0,
    fb: '✅ ينصّ قانون الانعكاس على أنّ زاوية السقوط = زاوية الانعكاس، وتُقاس كلتا الزاويتين من العمود المقام على سطح المرآة.'
  },
  g8bio3n4: {
    q: 'ماذا نسمّي التغيّر في اتّجاه الشعاع الضوئي عند انتقاله من وسط شفّاف إلى وسط شفّاف آخر؟',
    opts: ['الانكسار', 'الانعكاس', 'التشتّت', 'الامتصاص'],
    ans: 0,
    fb: '✅ الانكسار (Refraction) هو التغيّر في اتّجاه الشعاع الضوئي عند انتقاله من وسط شفّاف إلى وسط شفّاف آخر، كما في حالة القلم الذي يبدو منحرفاً داخل الماء.'
  },
  g8bio3n5: {
    q: 'ما اسم الظاهرة التي يتحلّل فيها الضوء الأبيض إلى ألوان الطيف عند مروره بمنشور زجاجي؟',
    opts: ['التشتّت (Dispersion)', 'الانعكاس (Reflection)', 'الامتصاص (Absorption)', 'التبخّر (Evaporation)'],
    ans: 0,
    fb: '✅ يُسمّى تحليل الضوء الأبيض إلى ألوان الطيف السبعة بالتشتّت (Dispersion)، وتظهر الألوان دائماً بالترتيب نفسه: أحمر، برتقالي، أصفر، أخضر، أزرق، نيليّ، بنفسجيّ.'
  },
  g8bio3n6: {
    q: 'لماذا نرى العشب أخضر اللون؟',
    opts: ['لأنّ العشب يعكس الضوء الأخضر ويمتصّ معظم الألوان الأخرى', 'لأنّ العشب يصدر ضوءاً أخضر بنفسه', 'لأنّ عين الإنسان تحوّل كلّ الألوان إلى الأخضر', 'لأنّ الضوء الأبيض لا يحتوي إلّا على اللون الأخضر'],
    ans: 0,
    fb: '✅ يحتوي ضوء الشمس الأبيض على جميع الألوان، لكنّ العشب يعكس الضوء الأخضر إلى أعيننا ويمتصّ معظم الألوان الأخرى، لذلك نراه أخضر.'
  },
  g8mot6n1: {
    q: 'ما تعريف السرعة المتوسّطة؟',
    opts: ['المسافة التي يقطعها جسم ما خلال وحدة الزمن', 'الزمن الذي يستغرقه جسم ليقطع مسافة معيّنة', 'وزن الجسم مقسومًا على حجمه', 'القوة المؤثّرة على الجسم أثناء حركته'],
    ans: 0,
    fb: '✅ السرعة المتوسّطة هي المسافة المقطوعة مقسومة على الزمن المستغرق: السرعة = المسافة ÷ الزمن.'
  },
  g8mot6n2: {
    q: 'ماذا يحدث عندما تقطع سيّارة شعاع البوابة الضوئية؟',
    opts: ['ترسل البوابة نبضة كهربائية إلى جهاز قياس الزمن الإلكتروني', 'تتوقّف السيّارة تلقائيًا', 'ينطفئ شعاع الأشعة تحت الحمراء نهائيًا', 'لا يحدث شيء'],
    ans: 0,
    fb: '✅ عندما يقطع جسم الشعاع تحت الأحمر لأحد البوابتين الضوئيتين، ترسل البوابة نبضة كهربائية إلى جهاز قياس الزمن الإلكتروني ليبدأ أو يوقف القياس.'
  },
  g8mot6n3: {
    q: 'تتحرّك حافلة بسرعة متوسّطة 25 m/s. ما المسافة التي تقطعها خلال دقيقة واحدة (60 s)؟',
    opts: ['25 m', '60 m', '1500 m', '1525 m'],
    ans: 2,
    fb: '✅ المسافة = السرعة × الزمن = 25 m/s × 60 s = 1500 m.'
  },
  g8mot6n4: {
    q: 'في صور النابض الزمني، ماذا يعني تزايد التباعد بين الصور المتتالية؟',
    opts: ['أنّ الجسم يتحرّك بسرعة متزايدة (يتسارع)', 'أنّ الجسم توقّف عن الحركة', 'أنّ الجسم يتحرّك بسرعة ثابتة', 'أنّ الكاميرا كانت معطّلة'],
    ans: 0,
    fb: '✅ التباعد المتزايد بين الصور المتتالية يعني أنّ الجسم يقطع مسافة أكبر في كلّ فترة زمنية متساوية، أي أنّ سرعته تتزايد (يتسارع) — كما في الكرة المتدحرجة على منحدر.'
  },
  g8mot6n5: {
    q: 'في الرسم البياني للمسافة والزمن لرحلة درّاجة هوائية، متى يكون الخطّ أفقيًا تمامًا؟',
    opts: ['عندما يتحرّك الراكب بسرعة كبيرة جدًا', 'عندما يتوقّف الراكب عن الحركة (استراحة)', 'عندما يتحرّك الراكب بسرعة ثابتة', 'لا يحدث هذا أبدًا في الرسم البياني'],
    ans: 1,
    fb: '✅ الخطّ الأفقي (بلا انحدار) يعني أنّ المسافة لا تتغيّر مع مرور الزمن، أي أنّ الجسم متوقّف تمامًا — كما حدث أثناء استراحة محمد على درّاجته.'
  },
  g8mot6n6: {
    q: 'أيّ الطرق التالية تجعل فتح الباب أسهل بالقوة نفسها؟',
    opts: ['الدفع قريبًا جدًا من المفصلات (المحور)', 'الدفع بعيدًا عن المفصلات (عند المقبض)', 'الدفع في منتصف المفصلات تمامًا', 'لا فرق أين تدفعين الباب'],
    ans: 1,
    fb: '✅ الدفع بعيدًا عن المحور (المفصلات) بالقوة نفسها يُنتج عزم دوران أكبر، لذلك يسهل فتح الباب أكثر.'
  },
  g8mot6n7: {
    q: 'ما الشرط اللازم لتوازن عارضة تدور حول محور؟',
    opts: ['أن تكون الأوزان على الجانبين متساوية دائمًا', 'أن تكون المسافات عن المحور متساوية دائمًا', 'أن يتساوى عزم الدوران باتّجاه عقارب الساعة مع عزم الدوران عكس اتّجاهها', 'ألّا توجد أيّ قوى مؤثّرة على العارضة'],
    ans: 2,
    fb: '✅ ينصّ مبدأ عزم القوة على أنّه لتوازن العارضة، يجب أن يكون عزم الدوران باتّجاه عقارب الساعة مساويًا لعزم الدوران عكس اتّجاه عقارب الساعة — وليس بالضرورة أن تتساوى الأوزان أو المسافات وحدها.'
  },
  g8mot6n8: {
    q: 'قوّة مقدارها 50 N تؤثّر على مسافة 0.8 m من المحور. ما مقدار عزم هذه القوّة؟',
    opts: ['20 N·m', '40 N·m', '50.8 N·m', '62.5 N·m'],
    ans: 1,
    fb: '✅ العزم = القوة × المسافة من المحور = 50 N × 0.8 m = 40 N·m.'
  },
  g8chem2n9: {
    q: 'ما الفرق الرئيسي بين المخلوط والمركّب؟',
    opts: ['في المركّب تتّحد المواد كيميائياً وتفقد خصائصها الأصلية، وفي المخلوط يحتفظ كلّ مكوّن بخصائصه', 'لا فرق بينهما', 'المخلوط دائماً سائل والمركّب دائماً صلب', 'المركّب لا يمكن تكوينه إلا من الحديد والكبريت فقط'],
    ans: 0,
    fb: '✅ يحمل المركّب خصائص مختلفة كليّاً عن خصائص العناصر التي يتكوّن منها (كما في كبريتيد الحديد)، بينما في المخلوط يحتفظ كلّ عنصر أو مركّب بخصائصه الأصلية (كما في الهواء أو مخلوط الحديد والكبريت).'
  },
  g8bio1n6: {
    q: 'ما اسم الأنسجة التي تنقل الماء والأملاح المعدنية داخل ساق النبات؟',
    opts: ['الأنسجة الوعائية الخشبية (Xylem)', 'الكلوروفيل', 'الثغور', 'قشرة الساق الخارجية فقط'],
    ans: 0,
    fb: '✅ تنتقل الماء والأملاح المعدنية من جذور النبات إلى أوراقه داخل أنابيب مجوّفة طويلة تُسمّى الأنسجة الوعائية الخشبية.'
  },
  g8bio1n5: {
    q: 'إلى أيّ اتجاه تنمو جذور النبات دائماً؟',
    opts: ['نحو الأسفل باتجاه الجاذبية', 'نحو الضوء دائماً', 'في نفس اتجاه البذرة دون تغيير', 'بشكل عشوائي'],
    ans: 0,
    fb: '✅ تنمو الجذور دائماً نحو الأسفل باتجاه الجاذبية، بغضّ النظر عن الاتجاه الذي وُضعت فيه البذرة.'
  },
  g8bio1n4: {
    q: 'لماذا يُستخدم اليود للكشف عن النشاء في الورقة؟',
    opts: ['لأن لونه يتحوّل إلى الأزرق الداكن/الأسود عند ملامسة النشاء', 'لأنه يُذيب النشاء', 'لأنه يُلوّن الورقة أخضر', 'لأنه يوقف التمثيل الضوئي'],
    ans: 0,
    fb: '✅ محلول اليود بنّي اللون، لكنه يتحوّل إلى الأزرق الداكن أو الأسود عند ملامسته للنشاء — وهذا يُستخدم كدليل على وجوده.'
  },
  g8bio1n3: {
    q: 'ماذا ينتج عن عملية التمثيل الضوئي؟',
    opts: ['الجلوكوز والأكسجين', 'ثاني أكسيد الكربون والماء فقط', 'النشاء فقط دون أكسجين', 'الكلوروفيل'],
    ans: 0,
    fb: '✅ ينتج عن التمثيل الضوئي الجلوكوز (الذي يُخزَّن غالباً على شكل نشاء) وغاز الأكسجين الذي يُطلَق إلى الهواء.'
  },
  g8bio1n2: {
    q: 'ماذا تكسب الورقة لونها الأخضر؟',
    opts: ['صبغة الكلوروفيل', 'الماء', 'التربة', 'ضوء الشمس مباشرة'],
    ans: 0,
    fb: '✅ تحتوي خلايا الورقة على صبغة الكلوروفيل، وهي المسؤولة عن اللون الأخضر وامتصاص طاقة الضوء للتمثيل الضوئي.'
  },
  g6body7: {
    q: 'ما الذي يحدث أولاً عند لمس شيء ساخن؟',
    opts: ['يرسل الجلد إشارة إلى الدماغ فيقرر سحب اليد', 'تتحرك اليد قبل أن يشعر الجلد', 'لا يحدث شيء', 'يتوقف القلب'],
    ans: 0,
    fb: '✅ الجلد (الحاسة) يرسل إشارة إلى الدماغ، فيفسّرها ويرسل أمراً فورياً للعضلات بسحب اليد لحمايتها.'
  },
  g6body6: {
    q: 'ماذا يحدث للفضلات بعد أن تُرشِّح الكليتان الدم؟',
    opts: ['تعود إلى الدم', 'تتحوّل إلى بول ويتخلّص منها الجسم', 'تبقى في الكليتين للأبد', 'تتحوّل إلى غذاء'],
    ans: 1,
    fb: '✅ تُرشِّح الكليتان الدم وتفصل الفضلات والماء الزائد عنه، وتتحوّل هذه المواد إلى بول يتخلّص منه الجسم.'
  },
  g6body5: {
    q: 'ما وظيفة الأمعاء الدقيقة في الجهاز الهضمي؟',
    opts: ['تُفتّت الطعام لجزيئات صغيرة تنتقل إلى الدم', 'تمضغ الطعام', 'تُخرج الفضلات فقط', 'تصنع اللعاب'],
    ans: 0,
    fb: '✅ الأمعاء الدقيقة تُكمل تفتيت الطعام إلى جزيئات صغيرة جداً بحيث يمكنها الانتقال عبر جدرانها إلى الدم لتغذية الجسم.'
  },
  g6body4: {
    q: 'ماذا يحدث أثناء الزفير؟',
    opts: ['يدخل الأكسجين', 'يخرج الهواء المحمَّل بثاني أكسيد الكربون', 'يتوقف القلب', 'تكبر الرئتان'],
    ans: 1,
    fb: '✅ أثناء الزفير تنكمش الرئتان ويخرج الهواء المحمَّل بثاني أكسيد الكربون، وهو الفضلات الغازية الناتجة عن نشاط الجسم.'
  },
  g6body3: {
    q: 'لماذا يختلف معدل النبض بين الجلوس والجري؟',
    opts: ['لأن الجري يحتاج طاقة وأكسجين أكثر فيسرع القلب لتلبية الحاجة', 'لأن الجري يبطئ القلب', 'لا علاقة بينهما', 'النبض ثابت دائماً'],
    ans: 0,
    fb: '✅ العضلات أثناء الجري تحتاج طاقة وأكسجين أكثر من حالة الجلوس، فيزيد القلب سرعة ضخّ الدم لتلبية هذا الاحتياج.'
  },
  g6body2: {
    q: 'ما الذي يُكوِّن الجهاز الدوري؟',
    opts: ['القلب والأوعية الدموية والدم معاً', 'القلب فقط', 'الدم فقط', 'الرئتان فقط'],
    ans: 0,
    fb: '✅ الجهاز الدوري يتكوّن من القلب الذي يضخّ الدم، والأوعية الدموية التي ينتقل عبرها، والدم الذي يحمل الغذاء والأكسجين وينقل الفضلات.'
  },
  g6body1: {
    q: 'لماذا يحتاج الجسم إلى أكثر من عضو ليعمل بشكل سليم؟',
    opts: ['لأن كل عضو له وظيفة محددة ويعتمد الجسم على تعاونها معاً', 'لأن عضواً واحداً يكفي لكل شيء', 'لأنها للزينة فقط', 'لا يوجد سبب'],
    ans: 0,
    fb: '✅ كل عضو (كالقلب والرئتين والدماغ) مسؤول عن وظيفة مختلفة، وتعمل جميعها معاً لتُبقي الجسم حياً وبصحة جيدة.'
  },
  g8bio1n1: {
    q: 'في تجربة تأثير الضوء على النمو، لماذا وُضع الوعاءان بنفس كمية الماء ونوع التربة؟',
    opts: ['لتوفير الوقت', 'ليكون الضوء هو المتغيّر الوحيد المختلف بينهما', 'لأن النبات يحتاج ماءً أكثر في الضوء', 'لا يوجد سبب علمي'],
    ans: 1,
    fb: '✅ في التجربة العلمية السليمة يجب أن يتغيّر عامل واحد فقط (هنا: الضوء) بينما تبقى بقية العوامل (الماء، التربة، كمية البذور) ثابتة؛ بذلك نتأكد أن الفرق في النمو سببه الضوء وحده.'
  },
  forces: {
...
function openSim(type) {
  ...
  var simGreets = {
    ...
    g8bio1n1:'النبات يصنع غذاءه من الضوء والماء! ☀️ اضغط الزر وشاهد التمثيل الضوئي يبدأ خطوة بخطوة',
    g8bio1n2:'لماذا الأوراق خضراء؟ 🍃 اقترب من الورقة واكتشف السرّ بنفسك!',
    g8bio1n3:'اضغط كل جزء من المعادلة لتكتشف دوره! ☀️',
    g8bio1n4:'هل تحتوي الورقة على نشاء؟ 🔬 اكتشف بنفسك في المختبر الافتراضي!',
    g8bio1n5:'إلى أين تنمو الجذور؟ 🌱 نفّذ التجربة وراقب النمو بنفسك!',
    g8bio1n6:'كيف ينتقل الماء داخل الساق؟ 🥬 راقب صبغة الكرفس وهي تصعد للأعلى!',
    g8chem2n9:'مخلوط أم مركّب؟ ⚗️ اخلط، سخّن، وشاهد الفرق بنفسك!',
    g8bio3n1:'هل يسير الضوء في خط مستقيم؟ 🕯️ رتّبي الثقوب واكتشفي بنفسك!',
    g8bio3n2:'ماذا يفعل الضوء بالمواد المختلفة؟ 🚗 وكيف يتكوّن الظلّ؟ 🌳',
    g8bio3n3:'مرآة أم ورقة؟ 🪞 وما العلاقة بين زاوية السقوط والانعكاس؟ 📐',
    g8bio3n4:'هل يبدو القلم مكسوراً في الماء؟ 🖊️ ولماذا ينكسر الضوء عند دخوله الزجاج؟ 📐',
    g8bio3n5:'اكتشفي طيف الضوء الأبيض عبر المنشور 🔺 — وأيّ الألوان ينكسر أكثر؟ 🌈',
    g8bio3n6:'كيف تعمل المرشّحات الملوّنة؟ 🔍 ولماذا نرى السيارة حمراء والعشب أخضر؟ 🚗🌿',
    g8mot6n1:'من الأسرع بين السيارات الثلاث؟ 🏁 واكتشفي علاقة السرعة بالمسافة والزمن!',
    g8mot6n2:'كيف تقيس البوابات الضوئية الزمن بدقّة؟ 📡 جرّبي بنفسك!',
    g8mot6n3:'احسبي السرعة أو المسافة أو الزمن باستخدام مثلّث السرعة 🔺',
    g8mot6n4:'راقبي السيارة والرسم البياني يتكوّن معًا 🚗📈 وقارني سرعة ثابتة بمتزايدة 📸',
    g8mot6n5:'قارني سيارتين بسرعتين مختلفتين 🔴🔵 وتتبّعي رحلة درّاجة غير منتظمة 🚵',
    g8mot6n6:'اكتشفي عزم دوران القوة عبر مفتاح البراغي 🔧 وفتح الباب 🚪',
    g8mot6n7:'وازني ميزان التفاح ⚖️ واكتشفي مبدأ عزم القوة على الأرجوحة 🎢',
    g8mot6n8:'احسبي عزم القوة أو المسافة أو القوّة المجهولة 🧮 وتحدّي نفسك بمسائل تطبيقية 📝',
    g8chem2n2:'ممّ تتكوّن الذرّة؟ ⚛️ اكتشف النواة والإلكترونات المتحركة حولها!',
    g7bio1n1:'ابنِ نباتاً بنفسك! 🌱 اسحبي كل جزء إلى مكانه الصحيح',
    g7bio1n2:'ركّبي زهرة واستكشفي أجزاءها! 🌸',
    g7bio1n3:'ساعدي النحلة تنقل حبوب اللقاح! 🐝',
    g7bio1n4:'تابعي رحلة حبّة اللقاح حتى الإخصاب! 🌼',
    g7bio1n5:'إلى أين تذهب البذور؟ 🍇 صنّفي واكتشفي!',
    g7bio1n6:'أيّ جهاز في جسمك هو المسؤول؟ 🧍 اكتشفي بنفسك!',
    g7bio1n7:'ساعدي حارس الجسم على حماية أعضائه! 🛡️ ثم جرّبي تجربة الماصّات',
    g7bio1n8:'جرّبي تحريك كل مفصل بنفسك واكتشفي نوعه! 🦴',
    g7bio1n9:'شاهدي عضلتَي ذراعك وهما تعملان معاً! 💪',
    g7bio1n10:'من التخصّص المناسب لكل مشكلة علمية؟ 🔎 خمّني بنفسك!',
    g5bio1n1:'ماذا يوجد داخل البذرة؟ 🌰 اكتشفي بنفسك!',
    g5bio1n2:'راقبي البذرة وهي تنبت خطوة بخطوة! 🌱',
    g5bio1n3:'هل تحتاج البذور فعلاً للهواء؟ 🌬️ جرّبي بنفسك!',
    g5bio1n4:'قارني أربعة نباتات نمت بظروف مختلفة! 🌿',
    g5bio1n5:'أيّ نبات سينمو أفضل: الشمس أم الظلام؟ ☀️',
    ...
    g6body1:     'كل عضو في جسمك له وظيفة مهمة! 🫀 اسحب الأعضاء إلى مكانها الصحيح واكتشف وظيفة كل واحد',
    g6body2:     'اضغط ابدأ وشاهد قلبك ينبض! ❤️ جرّب تغيير السرعة ثم تعرّف على رحلة الدم',
    g6body3:     'جالس أم تجري؟ 📈 شاهد نبضك يتغيّر مع الحركة!',
    g6body4:     'شهيق وزفير! 🫁 جرّب التنفس ثم وصّل الأكسجين إلى الدم',
    g6body5:     'اختر طعامك وتابع رحلته! 🍽️ من الفم إلى نهاية الرحلة',
    g6body6:     'شغّل الترشيح وشاهد الكليتين تعملان! 🫘 ثم افرز المواد بنفسك',
    g6body7:     'دماغك يتحكم بكل شيء! 🧠 اختر موقفاً وشاهد رحلة الإشارة العصبية',
    ...
    // ── الصف السادس — الوحدة ٢: الكائنات الحية في البيئة ──
    g6eco1: 'استكشف الموطن الطبيعي وابنِ أول سلسلة غذائية لك 🌱',
    g6eco2: 'كل شيء يبدأ من الشمس ☀️ — اكتشف كيف تبدأ النباتات السلسلة الغذائية',
    g6eco3: 'من يأكل من في الطبيعة؟ 🦅 اكتشف علاقات المفترس والفريسة',
    g6eco4: 'السافانا مختلفة عن المحيط 🌳🌊 — صنّف الكائنات وابنِ سلسلتين غذائيتين',
    g6eco5: 'ماذا يحدث عندما تختفي الأشجار؟ 🌳 جرّب بنفسك وشاهد الأثر',
    g6eco6: 'أين الهواء أكثر تلوثاً؟ 🔬 استخدم شرائح الفازلين واكتشف',
    g6eco7: 'هل يتأثر النبات بماء حمضي؟ 🍋 راقب التجربة ليوم بعد يوم',
    g6eco8: 'إلى أين تذهب هذه النفايات؟ ♻️ افرزها في مكانها الصحيح',
    g6eco9: 'حوّل منزلك إلى منزل صديق للبيئة 🏡🌍',
    // ── الصف السادس — الوحدة ٣: تغيّرات المادة ──
    g6changes1: 'الثلج يذوب ثم يتجمّد من جديد، لكن عود الثقاب المحترق لا يعود كما كان! 🔁🔥 اكتشف الفرق',
    g6changes2: 'غربال، فرز باليد، أم ترشيح؟ 🧻 اختر الأداة الصحيحة لكل مخلوط!',
    g6changes3: 'الملح يذوب في الماء ويختفي، لكن الرمل لا! 💧 اكتشف الفرق بين المحلول والمخلوط',
    g6changes4: 'حرارة، تحريك، أم حبيبات أصغر؟ ⏱️ اكتشف بنفسك ما الذي يُسرّع الذوبان',
    // ── الصف العاشر — كيمياء: الوحدة ١ ──
    g10chem1n1: 'إلكترونات صغيرة تسبح بين أيونات كبيرة! 🔵 اضغط الزر وشاهد سرّ الرابطة الفلزية',
    g10chem1n2: 'اضغط على أي عنصر واكتشف مجموعته في الجدول الدوري 🧭',
    g10chem1n4: 'الخارصين يواجه كبريتات النحاس! ⚗️ من سيربح المنافسة؟',
  };
...
function startSim(type, tab) {
  ...
  const fns = {
    ...
    // ── الصف 6 — جسم الإنسان (الفصل الدراسي الأول) ──
    g6body1:     [simG6Body1a, simG6Body1b],
    g6body2:     [simG6Body2a, simG6Body2b],
    g6body3:     [simG6Body3a, simG6Body3b],
    g6body4:     [simG6Body4a, simG6Body4b],
    g6body5:     [simG6Body5a, simG6Body5b],
    g6body6:     [simG6Body6a, simG6Body6b],
    g6body7:     [simG6Body7a, simG6Body7b],
    ...
    // ── الصف السادس — الوحدة ٢: الكائنات الحية في البيئة ──
    g6eco1: [simG6Eco1a, simG6Eco1b, simG6Eco1c],
    g6eco2: [simG6Eco2a, simG6Eco2b],
    g6eco3: [simG6Eco3a],
    g6eco4: [simG6Eco4a, simG6Eco4b],
    g6eco5: [simG6Eco5a],
    g6eco6: [simG6Eco6a, simG6Eco6b],
    g6eco7: [simG6Eco7],
    g6eco8: [simG6Eco8],
    g6eco9: [simG6Eco9],
    // ── الصف السادس — الوحدة ٣: تغيّرات المادة ──
    g6changes1: [simG6Chg1a, simG6Chg1b, simG6Chg1c],
    g6changes2: [simG6Chg2a, simG6Chg2b, simG6Chg2c],
    g6changes3: [simG6Chg3a, simG6Chg3b],
    g6changes4: [simG6Chg4a, simG6Chg4b, simG6Chg4c],
    // وحدة الكهرباء — الصف السادس
    ...
    // ── الصف 8 — النباتات (الفصل الدراسي الأول) ──
    g8bio1n1: [simG8Bio1N1a, simG8Bio1N1b],
    g8bio1n2: [simG8Bio1N2a, simG8Bio1N2b, simG8Bio1N2c],
    g8bio1n3: [simG8Bio1N3a],
    g8bio1n4: [simG8Bio1N4a],
    g8bio1n5: [simG8Bio1N5a],
    g8bio1n6: [simG8Bio1N6a],
    g8chem2n9: [simG8Chem2N9a, simG8Chem2N9b],
    g8bio3n1: [simG8Bio3N1a, simG8Bio3N1b],
    g8bio3n2: [simG8Bio3N2a, simG8Bio3N2b],
    g8bio3n3: [simG8Bio3N3a, simG8Bio3N3b],
    g8bio3n4: [simG8Bio3N4a, simG8Bio3N4b],
    g8bio3n5: [simG8Bio3N5a, simG8Bio3N5b],
    g8bio3n6: [simG8Bio3N6a, simG8Bio3N6b],
    g8mot6n1: [simG8Mot6N1a, simG8Mot6N1b],
    g8mot6n2: [simG8Mot6N2a, simG8Mot6N2b],
    g8mot6n3: [simG8Mot6N3a, simG8Mot6N3b],
    g8mot6n4: [simG8Mot6N4a, simG8Mot6N4b],
    g8mot6n5: [simG8Mot6N5a, simG8Mot6N5b],
    g8mot6n6: [simG8Mot6N6a, simG8Mot6N6b],
    g8mot6n7: [simG8Mot6N7a, simG8Mot6N7b],
    g8mot6n8: [simG8Mot6N8a, simG8Mot6N8b],
    g8chem2n2: [simG8Chem2N2a],
    g5water1: [simG5Water1a],
    g5water2: [simG5Water2a],
    g5water3: [simG5Water3a],
    g5water4: [simG5Water4a],
    g7states2: [simG7States2a, simG7States2b],
    g7states3: [simG7States3a],
    g7states5: [simG7States5a],
    g7energy1: [simG7Energy1a, simG7Energy1b],
    g7energy2: [simG7Energy2a],
    g7energy3: [simG7Energy3a],
    g7energy4: [simG7Energy4a, simG7Energy4b],
    g7energy5: [simG7Energy5a, simG7Energy5b],
    g7energy6: [simG7Energy6a],
    g7energy7: [simG7Energy7a, simG7Energy7b],
    g7energy8: [simG7Energy8a],
    g7energy9: [simG7Energy9a],
    // ── الصف السابع — الوحدة الرابعة: الخلايا والكائنات الحية ──
    g7cell1: [simG7Cell1a],
    g7cell2: [simG7Cell2a],
    g7cell3: [simG7Cell3a],
    g7cell4: [simG7Cell4a, simG7Cell4b],
    g7cell6: [simG7Cell6a],
    g7cell7: [simG7Cell7a],
    // ── الصف السابع — الوحدة الخامسة: الأرض ──
    g7earth2b: [simG7Earth2b],
    g7earth2c: [simG7Earth2c],
    g7earth4:  [simG7Earth4],
    g7earth5:  [simG7Earth5],
    g7bio1n1: [simG7Bio1N1a, simG7Bio1N1b],
    g7bio1n2: [simG7Bio1N2a, simG7Bio1N2b],
    g7bio1n3: [simG7Bio1N3a, simG7Bio1N3b, simG7Bio1N3c],
    g7bio1n4: [simG7Bio1N4a, simG7Bio1N4b],
    g7bio1n5: [simG7Bio1N5a, simG7Bio1N5b],
    g7bio1n6: [simG7Bio1N6a, simG7Bio1N6b],
    g7bio1n7: [simG7Bio1N7a, simG7Bio1N7b],
    g7bio1n8: [simG7Bio1N8a],
    g7bio1n9: [simG7Bio1N9a, simG7Bio1N9b],
    g7bio1n10: [simG7Bio1N10a],
    g5bio1n1: [simG5Bio1N1a],
    g5bio1n2: [simG5Bio1N2a],
    g5bio1n3: [simG5Bio1N3a, simG5Bio1N3b],
    g5bio1n4: [simG5Bio1N4a],
    g5bio1n5: [simG5Bio1N5a],
    // ── الصف 8 — الجهاز الدوري وتبادل الغازات ──
