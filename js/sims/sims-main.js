...
const SIM_META = {
  ...
  g6body2:      { title: '١-٢ · القلب', badge: '❤️ 6', tabs: ['استقصاء: نبضات القلب ❤️', 'رتّب مسار الدم 🔀'] },
...
const SIM_QUESTIONS = {
  ...
  g6body2: {
    q: 'ماذا يحدث لسرعة نبض القلب عندما تجري بسرعة؟',
    opts: ['تزيد لأن الجسم يحتاج دماً وأكسجين أكثر', 'تقل', 'تبقى ثابتة تماماً', 'يتوقف القلب'],
    ans: 0,
    fb: '✅ عند بذل مجهود يحتاج الجسم إلى غذاء وأكسجين أكثر بسرعة، فيزيد القلب من عدد نبضاته لضخّ الدم بشكل أسرع.'
  },
  g6body1: {
...
function openSim(type) {
  ...
  var simGreets = {
    ...
    g6body2:     'اضغط ابدأ وشاهد قلبك ينبض! ❤️ جرّب تغيير السرعة ثم رتّب مسار الدم',
